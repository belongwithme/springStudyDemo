...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	 ...
	 * </bean>
	 * <bean id ="teacher" class = "...Teacher.class"/>"
	 * <bean id="student" class="...Student.class"/>
	 * <bean id="replacer" class="...Replacer.class"/>
	 */
	/**
	...
	protected void prepareMethodOverride(MethodOverride mo) throws BeanDefinitionValidationException {
		...
		//如果为1，覆盖的方法不存在重载，在使用CGLIB增强阶段就不需要进行校验了
		//直到找到某个方法进行增强即可，否则在增强阶段还需要做特殊处理。
		else if (count == 1) {
