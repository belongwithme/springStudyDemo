...
/**
 * 主要目的是为了提供更灵活的应用程序上下文配置和管理功能，
 * 使开发人员能够更精细地控制上下文的行为和生命周期。这样可以适应不同的应用场景和需求。
 */
public interface ConfigurableApplicationContext extends ApplicationContext, Lifecycle, Closeable {
	 ...
	 *添加一个 BeanFactoryPostProcessor 实例，用于在应用程序上下文的 BeanFactory 初始化前对 bean 进行进一步的定制。
	 */
